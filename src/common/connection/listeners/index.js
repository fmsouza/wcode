...
export default (message) => {
    switch(message.type) {
        ...
        case ActionTypes.CREATE_DIRECTORY: return Files.updateProject(message.payload);
        case ActionTypes.CREATE_FILE: return Files.createFile(message.payload);
        case ActionTypes.DELETE_DIRECTORY: return Files.updateProject(message.payload);
        ...
        case ActionTypes.UPDATE_DIRECTORY: return Files.updateProject(message.payload);
        case ActionTypes.UPDATE_FILE: return Files.updateProject(message.payload);
